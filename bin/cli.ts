...
import { action, DEFAULT_ADDRESS, DEFAULT_PORT, DEFAULT_SCRAPE_INTERVAL, DEFAULT_JOB, DEFAULT_NETWORK } from "../index"
...
command.option('-j --job <string>', 'Job name', DEFAULT_JOB)
command.option('-n --network <string>', 'Network name', DEFAULT_NETWORK)
